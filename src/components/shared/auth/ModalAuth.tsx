        ...
        <DialogPanel className="relative max-w-[66%] rounded-lg border bg-transparent p-4 backdrop-blur-xl">
          ...
          <div className="flex">
            <section className="flex flex-col items-center justify-between py-24 pr-4 text-center">
              ...
              <p className="text-sm">For any questions, reach out to support@Quickbetdmovies.com</p>
            </section>
            <section className="flex flex-col items-center justify-between space-y-12 bg-neutral-850 px-6 pt-12 text-center">
              <DialogTitle className="text-5xl font-bold">
                {isLogin ? modalAuthConstants[0].title : modalAuthConstants[1].title}
              </DialogTitle>
              <Description className="text-lg">
                {isLogin ? modalAuthConstants[0].description : modalAuthConstants[1].description}
              </Description>
              <Image
                alt="Logo"
                className="size-96"
                height={546}
                src={isLogin ? modalAuthConstants[0].image : modalAuthConstants[1].image}
                width={547}
              />
            </section>
          </div>
